...
namespace Physics
{
    ...
    public:
        ...
        //与模型碰撞检测。
        bool preventCollision(LPD3DXMESH pMesh, const D3DXMATRIX & world);
    
    public:
        
        bool collision(const Triangle & tri, const D3DXMATRIX & world);

        bool clip(Physics::Polygon & polyInOut);

        int witchSide(const Triangle & tri, const D3DXMATRIX & world);
    ...
    public:
        ...
        std::vector<Physics::Polygon> m_debugPolygons;
    ...
    public:
        ...
        //射线拾取
        bool pick(LPD3DXMESH pMesh, const D3DXMATRIX & world);
