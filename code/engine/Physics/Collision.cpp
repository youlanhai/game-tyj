...
namespace Physics
{
    ...
    bool CollisionPrevent::clip(Physics::Polygon & polyInOut)
    {
    ...
    int CollisionPrevent::witchSide(const Triangle & tri, const D3DXMATRIX & world)
    {
    ...
    bool CollisionPrevent::collision(const Triangle & tri, const D3DXMATRIX & world)
    {
    ...
    bool CollisionPrevent::preventCollision(LPD3DXMESH pMesh, const D3DXMATRIX & world)
    {
        CollisionInfo info;
        info.pMesh = pMesh;
    ...
    bool RayCollision::pick(LPD3DXMESH pMesh, const D3DXMATRIX & world)
    {
        D3DXMATRIX invWorld;
