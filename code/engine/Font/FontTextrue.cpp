...
namespace Lazy
{
    ...
    bool FontTextureNode::lockOne(int & x, int & y)
    {
        ...
        //debugMessage(_T("lockOne i=%d x=%d y=%d"), m_index, x, y);
    ...
    bool FontTextureNode::create()
    {
        ...
        debugMessage(_T("create texture w=%d, h=%d, dw=%d, dh=%d"), m_width, m_height, m_dw, m_dh);
        return true;
    }
    //////////////////////////////////////////////////////////////////////////
