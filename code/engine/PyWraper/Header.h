...
#define VT3(rt, rtType, name, aType1, aType2, aType3) \
    rtType name(aType1 a1, aType2 a2, aType3 a3){ _VT(name, rt, a1, a2, a3); }\
...
namespace boost
{
    namespace python
    {
        ...
        template <typename T>
        T* get_pointer(RefPtr<T> const& p)
        {
            return p.get();
        }
    }
